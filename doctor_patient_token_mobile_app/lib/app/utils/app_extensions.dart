...
extension TokenStatusExtension on String {
  TokenStatusEnum toTokenStatus() {
    switch (toLowerCase()) {
      case 'hold':
        return TokenStatusEnum.hold;
      case 'free':
        return TokenStatusEnum.free;
      case 'booked':
        return TokenStatusEnum.booked;
      case 'checked':
        return TokenStatusEnum.checked;
      case 'pending':
        return TokenStatusEnum.pending;
      case 'cancelled':
        return TokenStatusEnum.cancelled;
      case 'skipped':
        return TokenStatusEnum.skipped;
      case 'payment required':
        return TokenStatusEnum.paymentRequired;
      default:
        return TokenStatusEnum.free;
    }
  }
